...
from cue_combination_dataset import CueCombinationConst
...
def main(config_path):
    ...
    # save path
    save_path = f'trained_model/cue_combination_const_sigma/{model_name}'
    ...
    train_dataset = CueCombinationConst(
    ...
    valid_dataset = CueCombinationConst(
        time_length=cfg['DATALOADER']['TIME_LENGTH'],
        time_scale=cfg['MODEL']['ALPHA'],
        mu_min=cfg['DATALOADER']['MU_MIN'],
        mu_max=cfg['DATALOADER']['MU_MAX'],
