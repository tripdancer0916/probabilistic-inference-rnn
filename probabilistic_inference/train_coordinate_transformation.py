...
from probabilistic_inference.dataset.coordinate_transformation_dataset import CoordinateTransform
from probabilistic_inference.model import RecurrentNeuralNetwork
...
def main(config_path):
    ...
    os.makedirs('trained_model/coordinate_transformation_sampling', exist_ok=True)
    save_path = f'trained_model/coordinate_transformation_sampling/{model_name}'
    ...
    train_dataset = CoordinateTransform(
