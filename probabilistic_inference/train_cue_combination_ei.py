...
def train(config_path):
    ...
    save_path = f'../trained_model/cue_combination_sampling_ei/{model_name}'
    ...
    for epoch in range(cfg['TRAIN']['NUM_EPOCH'] + 1):
        ...
        for i, data in enumerate(train_dataloader):
            ...
            _, output_list, hidden = model(inputs, hidden, cfg['DATALOADER']['TIME_LENGTH'])
